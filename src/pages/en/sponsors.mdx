...
SnowCamp is organized by a group of geeky volunteers. Their only motivation is to propose a unique conference gathering innovation and research.
...
<Button href="/pdf/sponsorship-prospectus-2027-en.pdf" title="Plaquette Sponsors" type="ext"/>

<a id="beers"></a>

# Beer at Meet & Greet

For the friendly Meet & Greet moment, the Thursday from 4:50 PM to 6:00 PM, one of the Etoile or Chamois sponsors can take care of distributing beer and soft drinks. The idea:
...
Plan can be adjusted based on the number of real sponsors.
...
For the Etoile sponsor, this registration sets your ranking and therefore the booth.
...
<p className="sponsorBefore">The registration for the SnowCamp {year} will open on</p>
<p className="sponsorOpened">The registration for the SnowCamp {year} has been open since</p>
...
<Button className="sponsorOpened" title="Registration form" href={edition.sponsorship.subscribe_link} type="ext"/>
