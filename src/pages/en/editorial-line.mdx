...
Each year, during the preparation of the SnowCamp conference, we organize a Call For Papers (CFP) to allow you, if you are a speaker, to propose the topics that matter most to you.
...
However, the number of topics presented at SnowCamp is limited, and we can't select everyone.
...
These tips are strongly inspired by the amazing work of Katia Aresti in her [Twitter thread](https://x.com/karesti/status/1079114352240795650).
Thanks to her ;-)

## The editorial line of SnowCamp
...
It is necessary for us to know which format your session fits into.
